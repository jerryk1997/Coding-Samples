...
public class WcArguments {
    ...
    private boolean lines, words, bytes, dash;
    ...
    public void parse(String... args) throws WcException {
        boolean parsingFlag = true, isLines = false, isWords = false, isBytes = false, hasFilesDash = false;
        // Parse arguments
